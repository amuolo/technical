...
BOOST_AUTO_TEST_CASE(fluid_insert_d) {
	auto intervals = tech::interval_mapx<myKey, myValue>(tech::insert_mode::fluid, myValue(0));
	intervals.insert({ myKey(1), myKey(3), myKey(-1), myKey(5), myKey(2), myKey(0), myKey(-4), myKey(-3) },
		             { myKey(1), myKey(4), myKey(4), myKey(6), myKey(5), myKey(2), myKey(-2), myKey(-3) },
		             { myValue(1), myValue(2), myValue(3), myValue(4), myValue(5), myValue(6), myValue(7), myValue(8) });
	// -4 -2 -1 0 2 5 6    
	//  7  0  3 6 5 4 0
...
BOOST_AUTO_TEST_CASE(fluid_insert_twice) {
	auto intervals = tech::interval_mapx<myKey, myValue>(tech::insert_mode::fluid, myValue(0));
	intervals.insert({ myKey(1), myKey(3), myKey(5) }, { myKey(2), myKey(3), myKey(6) }, { myValue(1), myValue(2), myValue(3) });
	intervals.insert({ myKey(4), myKey(8), myKey(-1) }, { myKey(4), myKey(12), myKey(1) }, { myValue(4), myValue(5), myValue(6) });
	// 1 2  5 6
...
BOOST_AUTO_TEST_CASE(fluid_tricky_repetitive_inserts) {
	auto intervals = tech::interval_mapx<myKey, myValue>(tech::insert_mode::fluid, myValue(0));
	// 3 6  8 15
	intervals.insert({ myKey(1), myKey(3), myKey(8) }, { myKey(10), myKey(6), myKey(15) }, { myValue(1), myValue(2), myValue(3) });
	intervals.insert({ myKey(0), myKey(2) }, { myKey(1), myKey(3) }, { myValue(4), myValue(5) });  // 0 1  2 3  3 6  8 15
	...
	BOOST_TEST(intervals.contains(myKey(8)) == true);    BOOST_TEST(intervals[myKey(8)] == myValue(3));
	BOOST_TEST(intervals.contains(myKey(9)) == true);    BOOST_TEST(intervals[myKey(9)] == myValue(3));
	BOOST_TEST(intervals.contains(myKey(10)) == true);   BOOST_TEST(intervals[myKey(10)] == myValue(3));
	BOOST_TEST(intervals.contains(myKey(11)) == true);   BOOST_TEST(intervals[myKey(11)] == myValue(3));
	BOOST_TEST(intervals.contains(myKey(12)) == true);   BOOST_TEST(intervals[myKey(12)] == myValue(3));
	BOOST_TEST(intervals.contains(myKey(13)) == true);   BOOST_TEST(intervals[myKey(13)] == myValue(3));
	BOOST_TEST(intervals.contains(myKey(14)) == true);   BOOST_TEST(intervals[myKey(14)] == myValue(3));
	BOOST_TEST(intervals.contains(myKey(15)) == false);  BOOST_TEST(intervals[myKey(15)] == myValue(0));
	BOOST_TEST(intervals.contains(myKey(16)) == false);  BOOST_TEST(intervals[myKey(16)] == myValue(0));
}

BOOST_AUTO_TEST_CASE(fluid_reaching_end_iterator) {
	auto intervals = tech::interval_mapx<myKey, myValue>(tech::insert_mode::fluid, myValue(0));
	intervals.insert({ myKey(1), myKey(5) }, { myKey(3), myKey(9) }, { myValue(1), myValue(2) });   // 1 3  5 9
	intervals.insert(myKey(8), myKey(10), myValue(3));                // 1 3  5 8 10
...
BOOST_AUTO_TEST_CASE(fluid_reaching_begin_iterator) {
	auto intervals = tech::interval_mapx<myKey, myValue>(tech::insert_mode::fluid, myValue(0));
	intervals.insert({ myKey(1), myKey(5) }, { myKey(4), myKey(9) }, { myValue(1), myValue(2) });   // 1 4  5 9
	intervals.insert(myKey(0), myKey(2), myValue(3));    // 0 2 4  5 9
	intervals.insert(myKey(-1), myKey(1), myValue(4));   // -1 1 2 4  5 9
...
BOOST_AUTO_TEST_CASE(fluid_in_consecutive_intervals) {
	auto intervals = tech::interval_mapx<myKey, myValue>(tech::insert_mode::fluid, myValue(0));
	intervals.insert({ myKey(0), myKey(5) }, { myKey(5), myKey(9) }, { myValue(1), myValue(2) });   // 0 5  5 9
	intervals.insert(myKey(2), myKey(3), myValue(3));   // 0 2 3 5 9
...
BOOST_AUTO_TEST_CASE(fluid_insert_between) {
	auto intervals = tech::interval_mapx<myKey, myValue>(tech::insert_mode::fluid, myValue(0));
	intervals.insert({ myKey(0), myKey(5) }, { myKey(2), myKey(9) }, { myValue(1), myValue(2) });  // 0 2  5 9
	intervals.insert(myKey(3), myKey(4), myValue(3));   // 0 2  3 4  5 9
...
BOOST_AUTO_TEST_CASE(fluid_insert_between_bis) {
	auto intervals = tech::interval_mapx<myKey, myValue>(tech::insert_mode::fluid, myValue(0));
	intervals.insert({ myKey(0), myKey(5) }, { myKey(2), myKey(9) }, { myValue(1), myValue(2) });  // 0 2  5 9
	intervals.insert(myKey(3), myKey(5), myValue(3));   // 0 2  3 5 9
...
BOOST_AUTO_TEST_CASE(fluid_insert_inside) {
	auto intervals = tech::interval_mapx<myKey, myValue>(tech::insert_mode::fluid, myValue(0));
	// 0 2 5  6 8
	intervals.insert({ myKey(0), myKey(2), myKey(6) }, { myKey(2), myKey(5), myKey(8) }, { myValue(1), myValue(2), myValue(3) });
	intervals.insert(myKey(0), myKey(1), myValue(4));   // 0 1 2 5  6 8
	intervals.insert(myKey(2), myKey(3), myValue(5));   // 0 1 2 3 5  6 8
...
BOOST_AUTO_TEST_CASE(fluid_insert_from_right) {
	auto intervals = tech::interval_mapx<myKey, myValue>(tech::insert_mode::fluid, myValue(0));
	intervals.insert({ myKey(0), myKey(5) }, { myKey(3), myKey(8) }, { myValue(1), myValue(2) });    // 0 3  5 8
	intervals.insert(myKey(3), myKey(4), myValue(3));   // 0 3 4  5 8
	intervals.insert(myKey(4), myKey(6), myValue(4));   // 0 3 4 6 8
	intervals.insert(myKey(3), myKey(5), myValue(5));   // 0 3 5 6 8
...
BOOST_AUTO_TEST_CASE(fluid_insert_from_right_1) {
	auto intervals = tech::interval_mapx<myKey, myValue>(tech::insert_mode::fluid, myValue(0));
	intervals.insert({ myKey(0) }, { myKey(5) }, { myValue(1) });
	intervals.insert(myKey(3), myKey(5), myValue(2));   // 0 3 5
...
BOOST_AUTO_TEST_CASE(fluid_insert_from_right_2) {
	auto intervals = tech::interval_mapx<myKey, myValue>(tech::insert_mode::fluid, myValue(0));
	intervals.insert({ myKey(0), myKey(5) }, { myKey(3), myKey(8) }, { myValue(1), myValue(2) });    // 0 3  5 8
	intervals.insert(myKey(2), myKey(4), myValue(3));   // 0 2 4  5 8
...
BOOST_AUTO_TEST_CASE(fluid_insert_from_right_3) {
	auto intervals = tech::interval_mapx<myKey, myValue>(tech::insert_mode::fluid, myValue(0));
	intervals.insert({ myKey(0), myKey(5) }, { myKey(3), myKey(8) }, { myValue(1), myValue(2) });    // 0 3  5 8
	intervals.insert(myKey(2), myKey(6), myValue(3));   // 0 2 6 8
...
BOOST_AUTO_TEST_CASE(fluid_insert_from_right_4) {
	auto intervals = tech::interval_mapx<myKey, myValue>(tech::insert_mode::fluid, myValue(0));
	intervals.insert({ myKey(0), myKey(5) }, { myKey(4), myKey(8) }, { myValue(1), myValue(2) });   // 0 4  5 8
	intervals.insert(myKey(2), myKey(5), myValue(3));   // 0 2 5 8
...
BOOST_AUTO_TEST_CASE(fluid_insert_consecutive) {
	auto intervals = tech::interval_mapx<myKey, myValue>(tech::insert_mode::fluid, myValue(0));
	intervals.insert({ myKey(0), myKey(2) }, { myKey(2), myKey(5) }, { myValue(1), myValue(2) });   // 0 2  2 5
...
BOOST_AUTO_TEST_CASE(fluid_insert_consecutive_bis) {
	auto intervals = tech::interval_mapx<myKey, myValue>(tech::insert_mode::fluid, myValue(0));
	intervals.insert({ myKey(0), myKey(1) }, { myKey(2), myKey(5) }, { myValue(1), myValue(2) });   // 0 1 5
...
BOOST_AUTO_TEST_CASE(fluid_insert_neighbours_1) {
	auto intervals = tech::interval_mapx<myKey, myValue>(tech::insert_mode::fluid, myValue(0));
	intervals.insert({ myKey(0), myKey(4) }, { myKey(2), myKey(6) }, { myValue(1), myValue(2) });   // 0 2  4 6
	intervals.insert(myKey(2), myKey(4), myValue(3));
...
BOOST_AUTO_TEST_CASE(fluid_insert_neighbours_2) {
	auto intervals = tech::interval_mapx<myKey, myValue>(tech::insert_mode::fluid, myValue(0));
	intervals.insert({ myKey(0), myKey(4) }, { myKey(2), myKey(6) }, { myValue(1), myValue(2) });   // 0 2  4 6
	intervals.insert(myKey(2), myKey(3), myValue(3));
...
BOOST_AUTO_TEST_CASE(fluid_insert_neighbours_3) {
	auto intervals = tech::interval_mapx<myKey, myValue>(tech::insert_mode::fluid, myValue(0));
	intervals.insert({ myKey(0), myKey(4) }, { myKey(2), myKey(6) }, { myValue(1), myValue(2) });   // 0 2  4 6
	intervals.insert(myKey(3), myKey(4), myValue(3));
...
BOOST_AUTO_TEST_CASE(fluid_insert_neighbours_4) {
	auto intervals = tech::interval_mapx<myKey, myValue>(tech::insert_mode::fluid, myValue(0));
	intervals.insert({ myKey(0), myKey(4) }, { myKey(2), myKey(6) }, { myValue(1), myValue(2) });   // 0 2  4 6
	intervals.insert(myKey(1), myKey(4), myValue(3));   // 0 1 4 6
...
BOOST_AUTO_TEST_CASE(fluid_insert_neighbours_5) {
	auto intervals = tech::interval_mapx<myKey, myValue>(tech::insert_mode::fluid, myValue(0));
	intervals.insert({ myKey(0), myKey(4) }, { myKey(2), myKey(6) }, { myValue(1), myValue(2) });   // 0 2  4 6
	intervals.insert(myKey(1), myKey(5), myValue(3));   // 0 1 5 6
...
BOOST_AUTO_TEST_CASE(fluid_insert_neighbours_6) {
	auto intervals = tech::interval_mapx<myKey, myValue>(tech::insert_mode::fluid, myValue(0));
	intervals.insert({ myKey(0), myKey(4) }, { myKey(2), myKey(6) }, { myValue(1), myValue(2) });   // 0 2  4 6
	intervals.insert(myKey(2), myKey(5), myValue(3));   // 0 2 5 6 
...
BOOST_AUTO_TEST_CASE(fluid_insert_neighbours_7) {
	auto intervals = tech::interval_mapx<myKey, myValue>(tech::insert_mode::fluid, myValue(0));
	intervals.insert({ myKey(0), myKey(5) }, { myKey(2), myKey(6) }, { myValue(1), myValue(2) });   // 0 2  5 6
	intervals.insert(myKey(3), myKey(4), myValue(3));
...
BOOST_AUTO_TEST_CASE(fluid_insert_neighbours_8) {
	auto intervals = tech::interval_mapx<myKey, myValue>(tech::insert_mode::fluid, myValue(0));
	intervals.insert({ myKey(0), myKey(4) }, { myKey(2), myKey(6) }, { myValue(1), myValue(2) });   // 0 2  4 6
	intervals.insert({ myKey(6), myKey(8) }, { myKey(8), myKey(10) }, { myValue(3), myValue(4) });  // 0 2  4 6  6 8  8 10
	intervals.insert(myKey(2), myKey(9), myValue(5));   // 0 2 9 10
...
BOOST_AUTO_TEST_CASE(fluid_insert_neighbours_9) {
	auto intervals = tech::interval_mapx<myKey, myValue>(tech::insert_mode::fluid, myValue(0));
	intervals.insert({ myKey(0), myKey(4) }, { myKey(2), myKey(6) }, { myValue(1), myValue(2) });   // 0 2  4 6
	intervals.insert({ myKey(6), myKey(8) }, { myKey(8), myKey(10) }, { myValue(3), myValue(4) });  // 0 2  4 6  6 8  8 10
	intervals.insert(myKey(2), myKey(12), myValue(5));   // 0 2 12
